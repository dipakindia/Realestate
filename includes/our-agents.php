        ...
        <div class="carousel-inner">
          <div class="item active">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="agent-1"> <a href="#" class="agent-img"> <img src="img/team.jpg" alt="team-1" class="img-responsive"> </a>
          ...
          <div class="item">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="agent-1"> <a href="#" class="agent-img"> <img src="img/team.jpg" alt="team-2" class="img-responsive"> </a>
                <div class="agent-content">
          ...
          <div class="item">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="agent-1"> <a href="#" class="agent-img"> <img src="img/team.jpg" alt="team-3" class="img-responsive"> </a>
                <div class="agent-content">
          ...
          <div class="item">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="agent-1"> <a href="#" class="agent-img"> <img src="img/team.jpg" alt="team-4" class="img-responsive"> </a>
                <div class="agent-content">
