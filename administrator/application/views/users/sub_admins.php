      ...
      <table class="table datatable-html">
        ...
        <tbody>
          ...
          <tr id="row_<?=$data->id;?>">
            ...
            <td><?php if($data->is_admin == 1){ echo '<span class="label label-success">Admin</span>'; }elseif($data->is_admin == 2){ echo '<span class="label label-success">Marketing</span>'; }elseif($data->is_admin == 3){ echo '<span class="label label-success">Data Entry</span>'; }?></td>
