      ...
      <div class="page-header page-header-default">
        <div class="page-header-content">
          <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Subscibers</h4>
          </div>
		...
		<div class="content">
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Subscibers</h5>
					<div class="heading-elements">
						<ul class="icons-list">
				...
				<table class="table datatable-html">
					...
					<?php $a = 0; foreach($alldata as $data){ $a++; ?>
						<tr id="row_<?=$data->id;?>">
							<td><?=$a;?></td>
							<td><?=ucfirst(getUserName($data->user_id));?></td>
							<td><?=ucfirst(getUserName($data->merchant_id));?></td>						   					              
							...
							<td class="text-center">
								<ul class="icons-list">
									<li><a href="javascript:void(0)" onClick="deleteData(<?=$data->id;?>)"><i class="icon-trash-alt"></i></a></li>
								</ul>
							</td>
...
<script>
	function deleteData(rid){
			...
			if(conf == true){
				var action = 'delete';
				var tblname = 'tbl_subscribe_list';
				var key = 'id';
				$.ajax({
			type: "POST",
