  ...
  <div class="page-header page-header-default">
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Add Offer</h4>
      </div>
      ...
      <div class="col-md-7">
        ...
        <form class="form-horizontal" action="" method="post" id="" enctype="multipart/form-data">
          ...
          <div class="panel-heading">
            <h5 class="panel-title">Add Offer</h5>
            <div class="heading-elements">
              <ul class="icons-list">
            ...
            <div class="panel-body">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Offer Name" name="offer_name" value="<?php echo isset($data->category_name)?$data->category_name:''; ?>" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select name="product_id" class="form-control">
					...
					$str = '';
					if($val->product_id == $product_info->product_id){ $str = 'selected="selected"';}
			   ...
			   <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Start Date" name="start_date" value="" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">End Date:</label>
                  <input type="text" class="form-control" placeholder="Enter End Date" name="end_date" value="" />
                </div>
              </div>
			  <div class="col-lg-6">
                <div class="form-group">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea  maxlength="100" class="form-control" name="offer_desc" placeholder="Enter your Offer Description here" ></textarea>
                </div>
              </div>
			  <div class="col-lg-12">
