      ...
      <div class="page-header page-header-default">
        <div class="page-header-content">
          <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Offer Sponser Plan</h4>
          </div>
		...
		<div class="content">
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Offer Sponser Plan</h5>
					<div class="heading-elements">
						<ul class="icons-list">
...
<script>
	function deleteData(rid){
			...
			if(conf == true){
				var action = 'delete';
				var tblname = 'tbl_sponser_plans_records';
				var key = 'id';
				$.ajax({
			type: "POST",
