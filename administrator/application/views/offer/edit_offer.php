  ...
  <div class="page-header page-header-default">
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Edit Offer</h4>
      </div>
      ...
      <div class="col-md-7">
		...
		?>
          <div class="form-group">
			<input type="hidden" value="<?php echo $offer_info->offer_id; ?>" name="'offer_id" >
            <div class="panel-body">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">Product Name:</label>
                  <input type="text" class="form-control" placeholder="Enter offer Name" name="offer_name" value="<?php echo isset($offer_info->offer_title)?$offer_info->offer_title:''; ?>" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">Select Product:</label>
                   <select name="product_id" class="form-control">
					...
					$str = '';
					if($val->product_id == $offer_info->product_id){ $str = 'selected="selected"';}
					//if($val->category_id == $product_info->product_id){
					echo '<option value="'.$val->product_id.'" '.$str.'>'.ucfirst($val->product_title).'</option>';
					//}
					}
					?>
                  </select>
			   ...
			   <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Start Date" name="start_date" value="<?php echo isset($offer_info->start_date)?$offer_info->start_date:''; ?>" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">End Date:</label>
                  <input type="text" class="form-control" placeholder="Enter End Date" name="end_date" value="<?php echo isset($offer_info->end_date)?$offer_info->end_date:''; ?>" />
                </div>
              </div>
			  ...
			  <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select name="status" class="form-control">
					...
					<option value="1" <?php if($offer_info->status == '1'){ echo 'selected="selected"';}?> >Active</option>
					<option value="0" <?php if($offer_info->status == '0'){ echo 'selected="selected"';}?>>Inactive</option>
                  </select>
                </div>
              </div>
			  <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="file" name="offer_image[]" value="" multiple="multiple" />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group">
			  ...
			  echo '<div class="col-lg-2" id="offer_image_'.$image->offer_image_id.'"><img src="'.base_url("uploads/offer_images/").$image->image_url.'" width="80" height="80" /><a href="javascript:void(0)" onClick="deleteData('.$image->offer_image_id.')">delete</a></div>';
			  }
			  }
			  ?></div>
			  </div>
...
<script>
	function deleteData(rid){
			...
			if(conf == true){
				var action = 'delete';
				var tblname = 'tbl_offer_images';
				var key = 'offer_image_id';
				$.ajax({
			type: "POST",
