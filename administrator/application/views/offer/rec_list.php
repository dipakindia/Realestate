					...
					<?php $a = 0; foreach($alldata as $data){ $a++; ?>
						<tr id="row_<?=$data->offer_id;?>">
							...
							<td class="text-center">
								<ul class="icons-list">
									<li><a href="<?php echo site_url().'/dashboard/offer_information/'.$data->offer_id;?>" title="View Detail"><i class="icon-arrow-right16"></i></a><a href="javascript:void(0)" onClick="deleteData(<?=$data->offer_id;?>)"><i class="icon-trash-alt"></i></a></li>
								</ul>
							</td>
