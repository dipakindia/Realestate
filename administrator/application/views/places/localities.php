...
<div class="content-wrapper">
  ...
  <div class="page-header page-header-default">
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Locality</h4>
      </div>
  ...
  <div class="panel panel-flat">
    <div class="panel-heading">
      <h5 class="panel-title">Locality Records</h5>
      <div class="heading-elements">
        <ul class="icons-list">
    ...
    <table class="table datatable-html">
      ...
      <tbody>
        ...
        <tr id="row_<?=$data1->id;?>">
          <td><?=$a;?></td>
          <td><?=$data1->name;?></td>
          <td><?=getCityName($data1->city_id);?></td>
