      ...
      <div class="col-md-7">
        ...
        <form class="form-horizontal" action="" method="post" id="AddLesson" enctype="multipart/form-data">
          ...
          <div class="panel-heading">
            <h5 class="panel-title">Add Category Record</h5>
            <div class="heading-elements">
              <ul class="icons-list">
		...
		<?php endif; ?>
          <div class="form-group">
            <input type="hidden" value="<?php echo isset($data->category_id)?$data->category_id:''; ?>" name="category_id" >
			...
			<option value="1" <?php if($data->status=='1'){ echo 'selected="selected"'; } ?>  >Active</option>
			  ...
			  <label class="control-label">&nbsp;</label><br />
                  		<?php if($data->category_image){ echo '<img  width="50px" height="50" src="'.BASE_URLD.'uploads/category_images/'.$data->category_image.'">'; } ?>
                </div>
              <div class="col-lg-12">
                <div class="form-group">
              ...
              <div class="col-lg-3 pull-right"><br /><br /><br />
                <div class="text-right">
                  <input type="submit" name="update_speaker" class="btn btn-primary" value="Update" />
                </div>
              </div>
            </div>
          </div>
