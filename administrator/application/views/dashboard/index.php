<!-- Theme JS files -->
<script type="text/javascript" src="<?php echo BASE_URLD; ?>assets/js/plugins/visualization/d3/d3.min.js"></script>
<script type="text/javascript" src="<?php echo BASE_URLD; ?>assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
...
<script type="text/javascript" src="<?php echo BASE_URLD; ?>assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
...
<script type="text/javascript" src="<?php echo BASE_URLD; ?>assets/js/pages/dashboard.js"></script>
