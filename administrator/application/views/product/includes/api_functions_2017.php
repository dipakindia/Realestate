...
function getEventList($post){
			...
			$sql = mysql_query("SELECT `event_id`, `event_name`, `event_description`, `image`, `latitude`,`longitude`,`user_id`, `status`, `added_date` FROM `tbl_event_records` ORDER BY `added_date` DESC");
