  ...
  <div class="page-header page-header-default">
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Edit Product</h4>
      </div>
            ...
            <div class="panel-body">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Product Name" name="product_name" value="<?php echo isset($product_info->product_title)?$product_info->product_title:''; ?>" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select name="category_name" class="form-control">
					...
					$str = '';
					if($product_info->category_id == $val->category_id){ $str = 'selected="selected"';}
			   ...
			   <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select name="sub_category_name" class="form-control">
					...
					<option value="<?=$product_info->sub_category_id?>" selected="selected" ><?=getCategoryName($product_info->sub_category_id)?></option>
			  ...
			  <div class="col-lg-6">
                <div class="form-group">
				  ...
				  <option value="<?=$product_info->child_category_id?>" selected="selected" ><?=getCategoryName($product_info->child_category_id)?></option>
			   ...
			   <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Price" name="price" value="<?php echo isset($product_info->price)?$product_info->price:''; ?>" />
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="control-label">Discount Price:</label>
                  <input type="text" class="form-control" placeholder="Enter Discount Price" name="discount_price" value="<?php echo isset($product_info->discount_price)?$product_info->discount_price:''; ?>" />
                </div>
              </div>
			  <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select name="status" class="form-control">
					...
					<option value="1" <?php if($product_info->status == '1'){ echo 'selected="selected"';}?> >Active</option>
					<option value="0" <?php if($product_info->status == '0'){ echo 'selected="selected"';}?>>Inactive</option>
                  </select>
                </div>
              </div>
			  <div class="col-lg-6">
			  ...
			  echo '<div class="col-lg-2" id="product_image_'.$image->product_image_id.'"><img src="'.base_url("uploads/product_images/").$image->image_url.'" width="80" height="80" /><a href="javascript:void(0)" onClick="deleteData('.$image->product_image_id.')">delete</a></div>';
			  }
			  }
			  ?></div>
			  </div>
...
<script>
	function deleteData(rid){
			...
			if(conf == true){
				var action = 'delete';
				var tblname = 'tbl_product_images';
				var key = 'product_image_id';
				$.ajax({
			type: "POST",
